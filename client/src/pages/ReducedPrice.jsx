          ...
          <div className="flex flex-row flex-wrap justify-center  mx-4 my-4">
            {houses.length > 1 &&
              houses.map((house, index) =>
                house.tags[2] == "Reduced Price"||house.tags[2] == "Price Reduced" ? (
                  <div
                    key={index}
                    className="flex flex-col justify-center shadow-2xl mt-6 mx-4 rounded-2xl w-96 bg-[#ffffff] shadow-xl"
                  >
                    <span className="absolute bg-red-600 w-32 text-xs text-white  text-sm rounded-xl px-4 py-1 -mt-80 ml-2">
                      {" "}
                      {house.tags[2]}
                    </span>{" "}
                    <img
                    ...
                    <div className="flex flex-col p-2 ">
                      ...
                      <div className="text-lg font-semibold  text-center text-[#374151] pt-2">
                        ...
                        <span> </span>
                        {house.address.state}
                        <span> </span> {house.address.zipCode}
                      </div>
