    ...
    <>
      ...
      <div  className="">
        <div className="flex flex-row flex-wrap items-center justify-center  mx-2  ">
          {houses.length > 1 &&
            houses.map((house, index) => house.tags[2]=="Land"?(
              <div
                key={index}
                className="flex flex-col justify-center shadow-2xl mt-10 mx-4 rounded-2xl w-96 bg-[#ffffff] shadow-xl"
              >
                 <span className="absolute bg-red-600 w-16 text-xs text-white  text-sm rounded-xl px-4 py-1 -mt-96 -my-8 ml-2">
              {" "}
              {house.tags[2]}
            </span>{" "}
                <img
